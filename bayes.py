...
if __name__ == "__main__":
    df = pd.read_csv("trainData.txt",delimiter=',')
    df.to_csv('trainData.csv')
    c = Classifier(filename="trainData.csv", class_attr="buys_computer" )
    c.calculate_priori()
    ...
    c.hypothesis1 = {"age":'senior', "income":"high", "student":'yes' , "credit_rating":'fair'}
    c.hypothesis2 = {"age":'youth', "income":"high", "student":'yes' , "credit_rating":'fair'}
    c.hypothesis3 = {"age":'middle_aged', "income":"low", "student":'no' , "credit_rating":'excellent'}
